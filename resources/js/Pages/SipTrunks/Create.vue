                                    ...
                                    <div class="space-y-4">
                                        <div v-for="(phoneNumber, index) in form.phone_numbers" :key="index" class="flex items-center space-x-4">
                                            ...
                                            >
                                                ...
                                                <option v-for="pn in availablePhoneNumbers" :key="pn.id" :value="pn.id">
...
const availablePhoneNumbers = props.phoneNumbers.filter(pn => 
...
const submit = () => {
    form.post(route('sip-trunks.store'), {
        onError: (errors) => {
